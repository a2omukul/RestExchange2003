...
public class EmailResponse {
	...
	public EmailResponse(String id, String from, String subject,
			ArrayList<String> to, ArrayList<String> cc, String body,
			String dateTimeReceived, String textbody, String htmlbody,
